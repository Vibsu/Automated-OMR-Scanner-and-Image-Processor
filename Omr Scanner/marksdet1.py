...
def detect_bubbles_and_get_integrated_values1(image_path):
    ...
    margin_left = int(max_x * 0.064)  
    margin_top = int(max_y * 0.723)   
    margin_right = int(max_x * 0.533)  
    margin_bottom = int(max_y * 0.19546)

    grid_width = int((max_x - margin_left - margin_right) / 11.7)
...
if __name__ == "__main__":
    ...
    image_path = "./gat2.jpg"
    detect_bubbles_and_get_integrated_values1(image_path)
